...
// 선을 그리고있는 상태에서 마우스무브 이벤트가 발생하면 그려질 선의 위치를 동적으로 보여주도록 합니다
    window.kakao.maps.event.addListener(kakaoMap, 'mousemove', function (mouseEvent:any) {
...
// 선을 그리고있는 상태에서 마우스 오른쪽 클릭 이벤트가 발생하면 선 그리기를 종료합니다
    window.kakao.maps.event.addListener(kakaoMap, 'rightclick', function (mouseEvent:any) {
...
// HTML Content를 만들어 리턴하는 함수입니다
  ...
  return (
    <>
      <div id="kakaoMap" className="stroke"></div>
    </>
  )
}
